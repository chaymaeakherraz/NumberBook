...
public class MainActivity extends AppCompatActivity {
    ...
    private void syncContactsToServer() {
        if (contactList.isEmpty()) {
            Toast.makeText(this, "Charge d'abord les contacts", Toast.LENGTH_SHORT).show();
            return;
        }
